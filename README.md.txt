...
Front End/UI: PHP 5.x php-ldap

BackEnd- Python Scripts for fetching data from VMware Esxi Servers and vCenter for

Authentication- Supports both Local authentication and LDAP.
